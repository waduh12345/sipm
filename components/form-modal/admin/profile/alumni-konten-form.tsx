...
interface FormAlumniKontenProps {
  form: Partial<AlumniKonten> | undefined;
  setForm: (data: Partial<AlumniKonten>) => void;
  onCancel: () => void;
  onSubmit: () => void;
  readonly?: boolean;
  isLoading?: boolean;
...
export default function FormAlumniKonten({
  form,
  setForm,
  onCancel,
  onSubmit,
    ...
    <div className="bg-white dark:bg-zinc-900 rounded-lg p-6 w-full max-w-3xl space-y-4 max-h-[80vh] overflow-y-auto">
      <div className="flex justify-between items-center">
        <h2 className="text-lg font-semibold">
          {readonly
            ? "Detail Konten Alumni"
            : form.id
            ? "Edit Konten Alumni"
            : "Tambah Konten Alumni"}
        </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="flex flex-col gap-y-1 sm:col-span-2">
          ...
          <Textarea
            ...
            readOnly={readonly}
            placeholder="Masukkan deskripsi konten alumni"
            rows={5}
          />
        </div>
