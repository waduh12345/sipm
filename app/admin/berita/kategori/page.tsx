...
} from "@/services/admin/berita/kategori.service";
import type { Kategori } from "@/types/admin/berita/kategori";
import FormKategori from "@/components/form-modal/admin/berita/kategori-form";
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold">Kategori (Halaman Berita)</h1>
