...
interface FormKategoriGaleriProps {
...
export default function FormKategoriGaleri({
  form,
  setForm,
  onCancel,
  onSubmit,
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 rounded-lg p-6 w-full max-w-2xl space-y-4 max-h-[80vh] overflow-y-auto">
      <div className="flex justify-between items-center">
        <h2 className="text-lg font-semibold">
          {readonly
            ? "Detail Kategori Galeri"
            : form.id
