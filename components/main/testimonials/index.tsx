...
export default function TestimonialsPage() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content:
        "Sejak menjual produk di marketplace Aplikasi SIPPM, penjualan saya meningkat drastis. Ada banyak dukungan dan promosi yang membantu UMKM seperti saya.",
    },
    {
      id: 3,
      name: "Rudi, 55",
      ...
      <section className="px-6 lg:px-12 py-20 bg-gradient-to-b from-white to-[#6B6B6B]/10">
        <div className="container mx-auto text-center">
          ...
          >
            ...
            manfaat bergabung dengan Aplikasi SIPPM.
          </motion.p>
        ...
        <div className="container mx-auto">
          <div className="bg-gradient-to-r from-[#6B6B6B] to-[#6B6B6B]/90 rounded-3xl p-12 text-center text-white">
            ...
            <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
              ...
              dan bisnis dari Aplikasi SIPPM.
            </p>
            <motion.button
