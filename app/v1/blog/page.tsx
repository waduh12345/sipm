...
const BLOG_POSTS = [
  ...
  },
  {
    id: 2,
    title:
      "Jon Bernard & Associates Partner Receives Lexology Client Choice Award for Fintech",
    category: "Firm News",
    date: "2 December 2025",
    image:
      "https://www.ssek.com/wp-content/uploads/2025/12/WYR-Lexology-Client-Choice-2026-Blog-Image.jpg",
    link: "#",
  },
  {
    id: 3,
    ...
    image:
      "https://www.ssek.com/wp-content/uploads/2025/11/The-International-Comparative-Legal-Guide-Cybersecurity-2026-Blog-Image.jpg",
    link: "#",
  },
  {
    id: 4,
    title:
      "Jon Bernard & Associates Named to GRR 100 Again in 2025 – Leading Restructuring Practice",
    category: "Firm News",
    date: "25 November 2025",
    image:
      "https://www.ssek.com/wp-content/uploads/2025/11/GRR_100_2025-Blog-Image.jpg",
    link: "#",
  },
  {
    id: 5,
    title:
      "Doing Business in Indonesia: Webinar Highlights Market Entry and Investment Guidance",
    category: "Events",
    date: "24 November 2025",
    image:
      "https://www.ssek.com/wp-content/uploads/2025/11/ICCC-Jon Bernard & Associates-Webinar-Blog-Image.jpg",
    link: "#",
  },
  {
    id: 6,
    title:
      "Briefing on Indonesia’s Updated Risk-Based Business Licensing Framework",
    category: "Events",
    date: "20 November 2025",
    image:
      "https://www.ssek.com/wp-content/uploads/2025/11/SSEK-Hosts-Briefing-on-Indonesias-Updated-Risk-Based-Business-Licensing-Framework-Blog-Image.jpg",
    link: "#",
  },
];
      ...
      <section className="py-10 lg:py-20">
        <div className="container mx-auto px-6">
          ...
          {/* PERUBAHAN: 
                ...
                3. pb-12 jadi pb-8 
            */}
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-12 mb-10 lg:mb-20 border-b border-gray-100 pb-8 lg:pb-12">
            {/* Category Filter */}
          ...
          {/* --- BLOG GRID --- */}
          {/* PERUBAHAN: gap-y-16 jadi gap-y-10 di mobile agar tidak terlalu jauh antar artikel */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-10 lg:gap-y-16">
            {BLOG_POSTS.map((post) => (
              ...
              >
                {/* Image Container */}
                {/* PERUBAHAN: mb-6 jadi mb-4 di mobile */}
                <div className="relative aspect-[16/10] w-full mb-4 lg:mb-6 overflow-hidden rounded-2xl shadow-sm border border-gray-100">
                  <Image
                    src={post.image}
                    alt={post.title}
                    fill
          ...
          {/* Load More Button */}
          {/* PERUBAHAN: mt-24 jadi mt-12 di mobile */}
