...
interface FormHajiBreadcrumbProps {
...
export default function FormHajiBreadcrumb({
  form,
  setForm,
  onCancel,
  onSubmit,
    ...
    <div className="bg-white dark:bg-zinc-900 rounded-lg p-6 w-full max-w-3xl space-y-4 max-h-[80vh] overflow-y-auto">
      <div className="flex justify-between items-center">
        <h2 className="text-lg font-semibold">
          {readonly
            ? "Detail Breadcrumb Haji Kami"
            : form.id
            ? "Edit Breadcrumb Haji Kami"
            : "Tambah Breadcrumb Haji Kami"}
        </h2>
