  ...
  return (
    <div className="min-h-screen font-sans text-[#57595f] selection:bg-[#2f4e9b] selection:text-white bg-[#f7fbff]">
        ...
        <div className="container mx-auto px-6 mb-20">
            ...
            <div className="w-11/12 mx-auto flex flex-col lg:flex-row gap-12 items-center">
                ...
                <div className="lg:w-5/12">
                    <h3 className="text-2xl lg:text-4xl text-[#2f4e9b] font-light leading-snug mb-8">
                        Combining experience and expertise, the highest standards of service, and innovation to guide clients and deliver timely solutions.
                    </h3>
                    <div className="text-[#57595f] font-light leading-relaxed space-y-6 text-sm lg:text-base">
                        <p>Our attorneys offer the highest levels of local and international expertise and experience, expertise that is continually updated and enhanced through further advanced training and education, both in Indonesia and abroad.</p>
                        <p>In terms of quality, we only know one way to do our job – correctly, professionally and to international standards. We concentrate on being thorough, applying the highest standards of integrity, never taking shortcuts or taking chances on the unknown.</p>
                    </div>
                </div>
            </div>
        </div>
      ...
      <section className="bg-[#2f4e9b] py-24 text-white overflow-hidden">
        ...
        {/* Image Story Full Width */}
        <div className="mt-12 relative w-full h-[50vh] lg:h-[80vh]">
             <Image 
                src="http://ssek.com/wp-content/uploads/2022/07/SSEK_Web-Our-Firm.jpg"
                alt="Story Image"
                fill
            ...
            <div className="flex flex-col lg:flex-row gap-16 mb-20">
                <div className="lg:w-5/12">
                    <h3 className="text-3xl lg:text-4xl text-[#2f4e9b] font-light leading-snug mb-8">
                        JONB is affiliated with a number of influential organizations that recognize the firm’s standing and enhance its international and professional connections.
                    </h3>
                </div>
