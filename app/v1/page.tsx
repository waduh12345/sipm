...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen font-sans text-gray-600 selection:bg-[#2f4e9b] selection:text-white bg-white">
        ...
        <div className="container mx-auto px-6 h-full relative z-20 flex flex-col justify-center">
            <div className="flex flex-col lg:flex-row items-end lg:items-center justify-between w-full h-full pb-20 lg:pb-0 pt-32">
                ...
                <div className="lg:w-8/12 mb-10 lg:mb-0">
                    ...
                    <div className="flex items-center gap-3 mb-6 text-[#FCD400] uppercase text-sm md:text-xl tracking-[0.15em] font-semibold">
      ...
      {/* --- OUR EXPERTISE --- */}
      <section className="py-20 md:py-32 bg-[#f7fbff]">
        <div className="container mx-auto px-6">
            <div className="flex flex-col lg:flex-row items-center">
                <div className="w-full">
                     <div className="flex items-center gap-3 mb-8 uppercase text-xs font-bold tracking-[0.2em] text-[#2f4e9b]">
                        <span className="w-8 h-[2px] bg-[#2f4e9b]"></span>
                        {t.home.expertise.title}
                    </div>
                    
                    <div className="text-gray-600 font-light leading-relaxed mb-10 text-base lg:text-lg">
      ...
      {/* --- NEWSLETTER / CONTACT --- */}
      <section className="relative py-20 md:py-32 bg-[#2f4e9b] overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-20 flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-2/3 w-full text-white">
                <div className="flex items-center gap-3 mb-6 uppercase text-xs font-bold tracking-[0.2em] text-[#FCD400]">
                    <span className="w-8 h-[2px] bg-[#FCD400]"></span>
                    {t.home.contact.title}
                </div>
                <p className="text-lg lg:text-2xl font-light text-white/90 leading-relaxed">
                    {t.home.contact.desc}
                </p>
            </div>
