...
interface FormHubungiBreadcrumbProps {
...
export default function FormHubungiBreadcrumb({
  form,
  setForm,
  onCancel,
  onSubmit,
    ...
    <div className="bg-white dark:bg-zinc-900 rounded-lg p-6 w-full max-w-3xl space-y-4 max-h-[80vh] overflow-y-auto">
      <div className="flex justify-between items-center">
        <h2 className="text-lg font-semibold">
          {readonly
            ? "Detail Breadcrumb Hubungi Kami"
            : form.id
            ? "Edit Breadcrumb Hubungi Kami"
            : "Tambah Breadcrumb Hubungi Kami"}
        </h2>
