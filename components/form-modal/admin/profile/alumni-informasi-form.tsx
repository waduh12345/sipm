...
interface FormAlumniInformasiProps {
  form: Partial<AlumniInformasi> | undefined;
  setForm: (data: Partial<AlumniInformasi>) => void;
  onCancel: () => void;
  onSubmit: () => void;
  readonly?: boolean;
  isLoading?: boolean;
...
export default function FormAlumniInformasi({
  form,
  setForm,
  onCancel,
  onSubmit,
    ...
    <div className="bg-white dark:bg-zinc-900 rounded-lg p-6 w-full max-w-3xl space-y-4 max-h-[80vh] overflow-y-auto">
      <div className="flex justify-between items-center">
        <h2 className="text-lg font-semibold">
          {readonly
            ? "Detail Alumni Informasi"
            : form.id
            ? "Edit Alumni Informasi"
            : "Tambah Alumni Informasi"}
        </h2>
