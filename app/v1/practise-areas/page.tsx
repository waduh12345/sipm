      ...
      <section className="py-12 lg:py-20">
        <div className="container mx-auto px-6">
            ...
            <div className="flex flex-col items-center text-center max-w-5xl mx-auto mb-16">
                <div className="flex items-center gap-3 uppercase text-xs font-bold tracking-[0.2em] text-[#2f4e9b] mb-6">
                    <span className="w-8 h-[2px] bg-[#2f4e9b]"></span>
                    {t.expertise.label}
                </div>
                <h2 className="text-2xl lg:text-4xl font-light text-gray-900 leading-tight mb-8">
            ...
            {/* Large Image */}
            <div className="relative w-full aspect-[16/9] lg:aspect-[21/9] mb-20 rounded-2xl overflow-hidden shadow-sm border border-gray-100">
                <Image 
            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start mb-24 border-b border-gray-100 pb-12">
                <div className="lg:w-1/3">
                    <h3 className="text-3xl text-gray-900 font-light mb-4">{t.expertise.intro.title}</h3>
            ...
            <div className="flex flex-col">
                ...
                {t.expertise.list.map((item, index) => (
                    <div key={index} className="border-b border-gray-100 last:border-0">
                        ...
                        >
                            <h4 className={`text-xl lg:text-2xl font-light transition-colors duration-300 pr-8 ${activeAccordion === index ? 'text-[#2f4e9b]' : 'text-gray-800 group-hover:text-[#2f4e9b]'}`}>
                                {item.title}
                            </h4>
                            ...
                            <div className="relative w-8 h-8 flex items-center justify-center shrink-0 border border-gray-200 rounded-full group-hover:border-[#2f4e9b] transition-colors">
                                {/* Horizontal line */}
                                <div className={`absolute w-3 h-[1.5px] bg-current transition-colors ${activeAccordion === index ? 'bg-[#2f4e9b]' : 'bg-gray-400 group-hover:bg-[#2f4e9b]'}`}></div>
                                {/* Vertical line */}
                                <motion.div 
                                    initial={false}
                        ...
                        <AnimatePresence>
                            {activeAccordion === index && (
                                ...
                                >
                                    <div className="pb-10 pl-0 lg:pl-4">
